...
export default function KPICard({ title, value, subtitle, icon: Icon, accent = 'zinc', delay = 0 }) {
  const accentMap = {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-xl border border-zinc-200/60 p-6 hover:border-zinc-300 transition-colors"
    >
